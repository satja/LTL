...
\shortauthors{Kurdija and Mihel\v{c}i\'c}
...
\cormark[1]
\author[2,3]{Matej Mihel\v{c}i\'c}[type=author,
                        role=Researcher,
...
\affiliation[2]{organization={Department of Mathematics, Faculty of Science, University of Zagreb},
                addressline={Bijeni\v{c}ka cesta 30}, 
                postcode={10000},  
                city={Zagreb},
                country={Croatia}}

\affiliation[3]{organization={Department of Electronics, Ru{\dj}er Bo\v{s}kovi\'c Institute},
                addressline={Bijeni\v{c}ka cesta 54}, 
                city={Zagreb},
                postcode={10000}, 
                country={Croatia}}
...
\begin{highlights}
\item We identify a locality-constrained fragment of LTL-based ethical planning that is solvable in polynomial time.
\item We develop a locality-based planner with shortest-plan and weighted conflict-resolution extensions.
\item On a 110-instance robotic benchmark suite, the method solves all instances and outperforms brute-force and automata/progression baselines.
\end{highlights}

\begin{keywords}
linear temporal logic \sep ethical planning \sep locality-based planning \sep conflict resolution
\end{keywords}
...
\bio{figures/kurdija.pdf}
\textbf{Adrian Satja Kurdija} is an assistant professor at the University of Zagreb Faculty of Electrical Engineering and Computing. His research interests include theoretical computer science, recommender systems, and optimization algorithms. He has published in \textit{IEEE Communications Letters}, \textit{European Journal of Operational Research}, \textit{International Journal of Web and Grid Services}, \textit{Knowledge-Based Systems}, \textit{IEEE Transactions on Services Computing}, \textit{Theoretical Computer Science}, and \textit{IEEE Access}.
\endbio

\bio{figures/matej.pdf}
\textbf{Matej Mihel\v{c}i\'c} is an assistant professor at the Department of Mathematics, Faculty of Science, University of Zagreb, and a scientific collaborator at the Department of Electronics, Ru{\dj}er Bo\v{s}kovi\'c Institute. His research focuses on data mining, specifically redescription mining, formal and theoretical aspects of data mining, applications of logic in computer science, machine learning, pattern recognition, and applications of machine learning and data mining methods to domain problems. Matej Mihel\v{c}i\'c has published over 20 scientific manuscripts and reviewed manuscripts for several journals and conferences. He has served as a program committee member of ICDM, ECML PKDD, and PAKDD.
\endbio
